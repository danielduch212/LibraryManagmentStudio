...
using LibraryManagementStudio.Views.User;
...
namespace LibraryManagement.App.Views.User
{
    public partial class UserBookListControl : UserControl
    {
        ...
        public UserBookListControl(Panel contentPanel, BookService bookService)
        {
            InitializeComponent();
        ...
        {
            _bookList = _bookService.GetBooks().ToList();
            SetupGridData();
        }

        private void SearchBooks()
        {
            _bookList = _bookService.GetBooks(searchBooksTextBox.Text).ToList();
            SetupGridData();
        }
        ...
        private void bookInfoButton_Click(object sender, EventArgs e)
        {
            ...
            {
                var control = new UserBookInfoControl(_contentPanel, _bookService, selectedBook);
